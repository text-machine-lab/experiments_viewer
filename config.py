...
#
# a dict db_name -> a list of tuples ('db_name - str', 'interface_name - str', 'show by default - boolean'),
# an example:
# {'zzz': [('score_train', 'Train Score', True), ]}
RESULTS_NAMES = {}

# define a dict db_name -> a list of filters
